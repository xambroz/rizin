...
CMDDESCS_C_TEMPLATE = """// SPDX-FileCopyrightText: 2020 RizinOrg <info@rizin.re>
// SPDX-License-Identifier: LGPL-3.0-only
//
...
class CmdDesc:
    ...
    def _validate(self, c):
        ...
        if (
            self.type in [CD_TYPE_ARGV, CD_TYPE_ARGV_MODES, CD_TYPE_ARGV_STATE, CD_TYPE_OLDINPUT]
            and not self.cname
        ):
